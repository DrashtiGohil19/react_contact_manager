...
function Edit() {
    ...
    const handleChange = (e) => {
        if (e.target.type === "radio") {
            setval({ ...val, gender: e.target.value });
        } else {
    ...
    return (
        <>
            ...
            <Form className='m-auto border border-dark rounded p-4 mb-4 justify-content-center' style={{ width: '45rem' }}>
                ...
                <Form.Select className='mb-3' value={val.city} name='city' onChange={handleChange}>
                ...
                <div className='d-flex mb-2' >
                    <Form.Check type="radio" className='me-2' name="gender" value="female" checked={val.gender === "female"} onChange={handleChange} />
                    <Form.Label className='me-4'>Femal</Form.Label>

                    <Form.Check type="radio" className='me-2' name="gender" value="male" checked={val.gender === "male"} onChange={handleChange} />
